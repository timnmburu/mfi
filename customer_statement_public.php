    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body1">
                <h3 class="card-title1">Request statement</h3>
                ...
                <form method="POST" action="">
                    <div class="form-floating mb-3">
                        ...
                        <label for="customer-phone"> Your Phone No.:</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input class="form-control" placeholder="Customer Phone Number" type="number" name="customer-code" id="customer-code" autocomplete="off" required>
                        <label for="customer-phone"> Enter Code Sent:</label>
                    </div>
                    <input class="button" type="submit" value="Request Statement" name="submitNewCode" id="submitNewCode" style="width: 150px; height: 30px; padding: 4px;" >
